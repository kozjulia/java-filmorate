...
22. Реализована функциональность "Оценки" - возможностьоценивать фильмы пользвателям, а также делать 
...
Тестовое покрытие кода 32%. Пример кода:
```java
public class Main {
...
3. `grade` - оценка от 1 до 10 включительно
